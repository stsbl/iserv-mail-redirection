...
use Stsbl\MailAliasBundle\Validator\Constraints\NotAccountValidator;
...
final class NotAccountValidatorTest extends ConstraintValidatorTestCase
{
    ...
    protected function createValidator(): ConstraintValidator
    {
        ...
        return new NotAccountValidator(new Config(['Domain' => 'example.test']), $this->groups, $this->users);
    }
