...
return [
    ...
    IServ\CrudBundle\IServCrudBundle::class => ['all' => true],
    IServ\FilesystemBundle\IServFilesystemBundle::class => ['all' => true],
    IServ\Bundle\Flash\IServFlashBundle::class => ['all' => true],
